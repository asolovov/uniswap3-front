...
export interface TokenPairAltInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addProvider"
      | "claimRoyalty"
...
export interface TokenPairAlt extends BaseContract {
  connect(runner?: ContractRunner | null): TokenPairAlt;
  waitForDeployment(): Promise<this>;

  interface: TokenPairAltInterface;
  ...
  closeOrder: TypedContractMethod<
    [caller: AddressLike, orderID: BigNumberish],
    [void],
    "nonpayable"
  >;
