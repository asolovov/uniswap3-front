...
export interface WrappedNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WrappedNative extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedNative;
