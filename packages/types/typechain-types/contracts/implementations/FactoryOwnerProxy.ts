...
export interface FactoryOwnerProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SPLIT_PERCENTAGE"
  ...
  encodeFunctionData(
    functionFragment: "pendingFactoryOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFactoryOwner",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPendingFactoryOwner",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface FactoryOwnerProxy extends BaseContract {
  connect(runner?: ContractRunner | null): FactoryOwnerProxy;
  waitForDeployment(): Promise<this>;

  interface: FactoryOwnerProxyInterface;
  ...
  pendingFactoryOwner: TypedContractMethod<[], [string], "view">;
  ...
  setFactoryOwner: TypedContractMethod<
  ...
  setPendingFactoryOwner: TypedContractMethod<
    [newOwner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "pendingFactoryOwner"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setFactoryOwner"
  ...
  >;
  getFunction(
    nameOrSignature: "setPendingFactoryOwner"
  ): TypedContractMethod<[newOwner: AddressLike], [void], "nonpayable">;
  getFunction(
