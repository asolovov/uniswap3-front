...
export interface WrappedZeroInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WrappedZero extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedZero;
  waitForDeployment(): Promise<this>;

  interface: WrappedZeroInterface;
