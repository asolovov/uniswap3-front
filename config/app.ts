...
export const CONTRACTS_CONFIG = {
  ...
  FACTORY_ADDRESS: process.env.NEXT_PUBLIC_FACTORY_ADDRESS || "0x",
  SWAP_ROUTER_ADDRESS: process.env.NEXT_PUBLIC_SWAP_ROUTER_ADDRESS || "0x",
  QUOTER_ADDRESS: process.env.NEXT_PUBLIC_QUOTER_ADDRESS || "0x",
} as const;
