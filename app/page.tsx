                ...
                <CardContent className="p-6">
                            ...
                            <PopoverContent className="w-80" align="end">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Tabs value={slippageMode}
                                              onValueChange={(v) => setSlippageMode(v as "auto" | "custom")}>
                                        ...
                                        {slippageWarning && (
                                            <Alert
                                                variant={slippageWarning.type === "error" ? "destructive" : "default"}>
                                                <AlertTriangle className="h-4 w-4"/>
                                                <AlertDescription
                                                    className="text-sm">{slippageWarning.message}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {validityWarning && (
                                            <Alert>
                                                <AlertTriangle className="h-4 w-4"/>
                                                <AlertDescription
                                                    className="text-sm">{validityWarning.message}</AlertDescription>
                                            </Alert>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div
                                    className="flex-1 text-2xl font-semibold text-gray-900">{receiveAmount || "0"}</div>
                    ...
                    <span>
                      1 {payToken.symbol} = {payToken.nativePrice / receiveToken.nativePrice} {receiveToken.symbol}
                    </span>
                                    {lastUpdated && (
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-left">
                            You need to give permission for the Uniswap protocol to spend your {payToken.symbol} tokens.
                            This is a one-time
                    ...
                    {payAmount} {payToken.symbol}
                        ...
                        <div className="text-xs text-gray-500">
                            This transaction will require gas fees. After approval, your swap will be executed
                            automatically.
                        </div>
                    </div>
